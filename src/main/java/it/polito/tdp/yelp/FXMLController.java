...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	{
    		txtResult.appendText(model.creaGrafo(cmbCitta.getValue()));
    	}
    	this.cmbB1.getItems().addAll(model.getVertici(cmbCitta.getValue()));
    ...
    void doCalcolaLocaleDistante(ActionEvent event) {
    	...
    	{
    		txtResult.appendText(model.getPiuLungo(cmbB1.getValue()));
    	}
